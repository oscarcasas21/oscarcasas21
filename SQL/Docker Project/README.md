...
```
history > oscarcasas-history.txt
```
...
- History file: oscarcasas-history.txt

- A report: Project-2-OscarCasas.ipynb

-  docker cluster used throughout project: docker-compose.yml

- Simplified Code for project: Project-2-Code.ipynb
